...
export const Marquee = ({
  ...
  return (
    <main
      className={`${className} font-bold relative  flex overflow-x-hidden border-y h-12 xs:h-16 sm:h-24 dark:border-dark-secondary border-light-secondary sm:text-7xl xs:text-5xl text-4xl items-center w-auto overflow-hidden`}
    >
...
export const ChangingEmoji = ({
  ...
  return (
    <p
      className={`${className} px-8 text-4xl sm:text-6xl xs:text-5xl ${fadeClass}`}
    >
      {emoji}
    </p>
  );
