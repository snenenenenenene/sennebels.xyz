    ...
    <>
      ...
      >
        ...
        >
          <section className="h-full card w-full overflow-hidden relative">
            ...
            {isHovered && (
              <Image
                ...
                onMouseMove={handleMouseMove}
                src={image}
                className="w-full md:block hidden card h-full object-cover transition-all duration-700 opacity-60"
                alt=""
                style={{
                  filter: `url(#noise-${id})`,
          ...
          <p className=" md:text-6xl text-3xl font-display ml-auto mt-2 md:mt-5">
            {title}
          </p>
        </Link>
      </section>
